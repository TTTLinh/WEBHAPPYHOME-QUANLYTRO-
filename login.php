...
if (isset($_POST["btn_submit"])) {
	...
	$conn = mysqli_connect("localhost", "root", "", "student_home");
	...
	if ($num > 0) {
		...
		// header('Location:dsdanhmucUser.php');
		...
		if($_SESSION['vaitro']=='admin'){
			...
			$_SESSION['user-admin']= $row['ten'];
			
		}if($_SESSION['vaitro']=='nguoidung'){
			
            $_SESSION['username']= $row['ten'];
            $_SESSION['sex']= $row['sex'];
            $_SESSION['date']= $row['date'];
            $_SESSION['phong']= $row['sophong'];
            $_SESSION['phong']= $row['sophong'];
